...
class CallHandler extends Controller
{
    ...
    public function missedCall(Request $request){
        ...
        $message = "Welcome to ShoppersStop. To register your First Citizen Card, click on the link http://shpr.st/reg/ or reply to 9212356765 in the below format"
    ...
    public function processSMS(Request $request){
        ...
        if(empty($card_number) || empty($name) || empty($email) || empty($dob)){
            ...
            $message = "Congratulations, your First Citizen Card has been successfully activated. We have credited 50 points to your account & your current balance is 256.45 points
